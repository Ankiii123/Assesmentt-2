...
public class Part2Application {
	private static final String URL = "jdbc:mysql://localhost:3306/charts";
	private static final String USER = "root";
	private static final String PASSWORD = "014638100@Agg";
	...
	public static void main(String[] args) throws SQLException, IOException {
		try {
			...
			String filePath = "C:\\unix_training\\Assessment-2\\Problem-2-charts\\src\\main\\resources\\Accolite.xlsx";
			List<ExcelData> dataList = parseExcel(filePath);

			insertData(dataList);

			// Step 5: Generate PDF and embed charts
			PdfGenerator.generatePdf(dataList, "C:\\unix_training\\Assessment-2\\Problem-2-charts\\src\\main\\resources\\Output.pdf");
